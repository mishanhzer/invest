...
export const GetOrdersResponse = {
    ...
    fromJSON(object) {
        return {
            orders: globalThis.Array.isArray(object?.orders) ? object.orders.map((e) => OrderState.fromJSON(e)) : [],
        };
    },
    toJSON(message) {
        const obj = {};
    ...
    fromJSON(object) {
        return {
            ...
            initialSecurityPrice: isSet(object.initialSecurityPrice)
                ? MoneyValue.fromJSON(object.initialSecurityPrice)
                : undefined,
            stages: globalThis.Array.isArray(object?.stages) ? object.stages.map((e) => OrderStage.fromJSON(e)) : [],
