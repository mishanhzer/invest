...
class CandlesReq {
    ...
    getInstrumentKey() {
        ...
        if (!key)
            throw new Error(`instrumentId or figi is required.`);
        return key;
    }
    getCacheFileName() {
        ...
        return path_1.default.join(this.options.cacheDir, 'candles', this.getInstrumentKey(), isYearChunk ? 'day' : candleIntervalToString(this.params.interval), `${dateStr}.json`);
    }
}
