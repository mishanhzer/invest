...
})(LastPriceType || (exports.LastPriceType = LastPriceType = {}));
function lastPriceTypeFromJSON(object) {
    switch (object) {
        case 0:
...
exports.lastPriceTypeFromJSON = lastPriceTypeFromJSON;
function lastPriceTypeToJSON(object) {
    switch (object) {
...
exports.lastPriceTypeToJSON = lastPriceTypeToJSON;
...
exports.MarketDataRequest = {
    encode(message, writer = minimal_js_1.default.Writer.create()) {
        ...
        if (message.ping !== undefined) {
            common_js_1.PingRequest.encode(message.ping, writer.uint32(58).fork()).ldelim();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 7:
                    ...
                    message.ping = common_js_1.PingRequest.decode(reader, reader.uint32());
                    continue;
                case 15:
                    if (tag !== 122) {
                        break;
    ...
    fromJSON(object) {
        return {
            ...
            getMySubscriptions: isSet(object.getMySubscriptions)
                ...
                : undefined,
            ping: isSet(object.ping) ? common_js_1.PingRequest.fromJSON(object.ping) : undefined,
    ...
    toJSON(message) {
        ...
        if (message.ping !== undefined) {
            obj.ping = common_js_1.PingRequest.toJSON(message.ping);
        }
        if (message.pingSettings !== undefined) {
...
exports.Candle = {
    ...
    toJSON(message) {
        ...
        if (message.open !== undefined) {
            obj.open = common_js_1.Quotation.toJSON(message.open);
        }
        if (message.high !== undefined) {
            obj.high = common_js_1.Quotation.toJSON(message.high);
        }
        if (message.low !== undefined) {
            obj.low = common_js_1.Quotation.toJSON(message.low);
        }
        if (message.close !== undefined) {
            obj.close = common_js_1.Quotation.toJSON(message.close);
        }
        if (message.volume !== 0) {
...
exports.OrderBook = {
    ...
    fromJSON(object) {
        return {
            ...
            time: isSet(object.time) ? fromJsonTimestamp(object.time) : undefined,
            limitUp: isSet(object.limitUp) ? common_js_1.Quotation.fromJSON(object.limitUp) : undefined,
            limitDown: isSet(object.limitDown) ? common_js_1.Quotation.fromJSON(object.limitDown) : undefined,
            instrumentUid: isSet(object.instrumentUid) ? globalThis.String(object.instrumentUid) : "",
            orderBookType: isSet(object.orderBookType) ? orderBookTypeFromJSON(object.orderBookType) : 0,
        };
    },
    toJSON(message) {
        ...
        if (message.limitUp !== undefined) {
            obj.limitUp = common_js_1.Quotation.toJSON(message.limitUp);
        }
        if (message.limitDown !== undefined) {
            obj.limitDown = common_js_1.Quotation.toJSON(message.limitDown);
        }
        if (message.instrumentUid !== "") {
            obj.instrumentUid = message.instrumentUid;
        }
...
exports.GetOrderBookResponse = {
    ...
    fromJSON(object) {
        return {
            ...
            bids: globalThis.Array.isArray(object?.bids) ? object.bids.map((e) => exports.Order.fromJSON(e)) : [],
            asks: globalThis.Array.isArray(object?.asks) ? object.asks.map((e) => exports.Order.fromJSON(e)) : [],
            lastPrice: isSet(object.lastPrice) ? common_js_1.Quotation.fromJSON(object.lastPrice) : undefined,
    ...
    toJSON(message) {
        ...
        if (message.lastPrice !== undefined) {
            obj.lastPrice = common_js_1.Quotation.toJSON(message.lastPrice);
        }
        if (message.closePrice !== undefined) {
...
exports.InstrumentClosePriceResponse = {
    encode(message, writer = minimal_js_1.default.Writer.create()) {
        ...
        if (message.eveningSessionPrice !== undefined) {
            common_js_1.Quotation.encode(message.eveningSessionPrice, writer.uint32(98).fork()).ldelim();
        }
        if (message.time !== undefined) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 12:
                    ...
                    message.eveningSessionPrice = common_js_1.Quotation.decode(reader, reader.uint32());
                    continue;
                case 21:
                    if (tag !== 170) {
                        break;
    ...
    fromJSON(object) {
        return {
            ...
            eveningSessionPrice: isSet(object.eveningSessionPrice)
                ? common_js_1.Quotation.fromJSON(object.eveningSessionPrice)
                : undefined,
            time: isSet(object.time) ? fromJsonTimestamp(object.time) : undefined,
        };
    },
    toJSON(message) {
        ...
        if (message.eveningSessionPrice !== undefined) {
            obj.eveningSessionPrice = common_js_1.Quotation.toJSON(message.eveningSessionPrice);
        }
        if (message.time !== undefined) {
            obj.time = message.time.toISOString();
        }
...
exports.GetTechAnalysisRequest = {
    encode(message, writer = minimal_js_1.default.Writer.create()) {
        ...
        if (message.from !== undefined) {
            timestamp_js_1.Timestamp.encode(toTimestamp(message.from), writer.uint32(26).fork()).ldelim();
        }
        if (message.to !== undefined) {
            timestamp_js_1.Timestamp.encode(toTimestamp(message.to), writer.uint32(34).fork()).ldelim();
        }
        if (message.interval !== 0) {
...
exports.GetTechAnalysisRequest_Deviation = {
    encode(message, writer = minimal_js_1.default.Writer.create()) {
        if (message.deviationMultiplier !== undefined) {
            common_js_1.Quotation.encode(message.deviationMultiplier, writer.uint32(10).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    message.deviationMultiplier = common_js_1.Quotation.decode(reader, reader.uint32());
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
                break;
    ...
    fromJSON(object) {
        return {
            deviationMultiplier: isSet(object.deviationMultiplier)
                ? common_js_1.Quotation.fromJSON(object.deviationMultiplier)
                : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
        if (message.deviationMultiplier !== undefined) {
            obj.deviationMultiplier = common_js_1.Quotation.toJSON(message.deviationMultiplier);
        }
        return obj;
    },
};
...
exports.GetTechAnalysisResponse_TechAnalysisItem = {
    encode(message, writer = minimal_js_1.default.Writer.create()) {
        ...
        if (message.middleBand !== undefined) {
            common_js_1.Quotation.encode(message.middleBand, writer.uint32(18).fork()).ldelim();
        }
        if (message.upperBand !== undefined) {
            common_js_1.Quotation.encode(message.upperBand, writer.uint32(26).fork()).ldelim();
        }
        if (message.lowerBand !== undefined) {
            common_js_1.Quotation.encode(message.lowerBand, writer.uint32(34).fork()).ldelim();
        }
        if (message.signal !== undefined) {
            common_js_1.Quotation.encode(message.signal, writer.uint32(42).fork()).ldelim();
        }
        if (message.macd !== undefined) {
            common_js_1.Quotation.encode(message.macd, writer.uint32(50).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 2:
                    ...
                    message.middleBand = common_js_1.Quotation.decode(reader, reader.uint32());
                    continue;
                case 3:
                    if (tag !== 26) {
                        break;
                    }
                    message.upperBand = common_js_1.Quotation.decode(reader, reader.uint32());
                    continue;
                case 4:
                    if (tag !== 34) {
                        break;
                    }
                    message.lowerBand = common_js_1.Quotation.decode(reader, reader.uint32());
                    continue;
                case 5:
                    if (tag !== 42) {
                        break;
                    }
                    message.signal = common_js_1.Quotation.decode(reader, reader.uint32());
                    continue;
                case 6:
                    if (tag !== 50) {
                        break;
                    }
                    message.macd = common_js_1.Quotation.decode(reader, reader.uint32());
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
                break;
    ...
    fromJSON(object) {
        return {
            ...
            middleBand: isSet(object.middleBand) ? common_js_1.Quotation.fromJSON(object.middleBand) : undefined,
            upperBand: isSet(object.upperBand) ? common_js_1.Quotation.fromJSON(object.upperBand) : undefined,
            lowerBand: isSet(object.lowerBand) ? common_js_1.Quotation.fromJSON(object.lowerBand) : undefined,
            signal: isSet(object.signal) ? common_js_1.Quotation.fromJSON(object.signal) : undefined,
            macd: isSet(object.macd) ? common_js_1.Quotation.fromJSON(object.macd) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.middleBand !== undefined) {
            obj.middleBand = common_js_1.Quotation.toJSON(message.middleBand);
        }
        if (message.upperBand !== undefined) {
            obj.upperBand = common_js_1.Quotation.toJSON(message.upperBand);
        }
        if (message.lowerBand !== undefined) {
            obj.lowerBand = common_js_1.Quotation.toJSON(message.lowerBand);
        }
        if (message.signal !== undefined) {
            obj.signal = common_js_1.Quotation.toJSON(message.signal);
        }
        if (message.macd !== undefined) {
            obj.macd = common_js_1.Quotation.toJSON(message.macd);
        }
        return obj;
    },
};
