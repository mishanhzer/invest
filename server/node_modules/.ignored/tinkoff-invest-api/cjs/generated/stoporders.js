...
exports.PostStopOrderRequest = {
    ...
    fromJSON(object) {
        return {
            ...
            stopPrice: isSet(object.stopPrice) ? common_js_1.Quotation.fromJSON(object.stopPrice) : undefined,
    ...
    toJSON(message) {
        ...
        if (message.stopPrice !== undefined) {
            obj.stopPrice = common_js_1.Quotation.toJSON(message.stopPrice);
        }
        if (message.direction !== 0) {
...
exports.PostStopOrderRequest_TrailingData = {
    encode(message, writer = minimal_js_1.default.Writer.create()) {
        if (message.indent !== undefined) {
            common_js_1.Quotation.encode(message.indent, writer.uint32(10).fork()).ldelim();
        }
        if (message.indentType !== 0) {
            writer.uint32(16).int32(message.indentType);
        }
        if (message.spread !== undefined) {
            common_js_1.Quotation.encode(message.spread, writer.uint32(26).fork()).ldelim();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    message.indent = common_js_1.Quotation.decode(reader, reader.uint32());
                    continue;
                case 2:
                    if (tag !== 16) {
                        break;
                ...
                case 3:
                    ...
                    message.spread = common_js_1.Quotation.decode(reader, reader.uint32());
                    continue;
                case 4:
                    if (tag !== 32) {
                        break;
    ...
    fromJSON(object) {
        return {
            indent: isSet(object.indent) ? common_js_1.Quotation.fromJSON(object.indent) : undefined,
            indentType: isSet(object.indentType) ? trailingValueTypeFromJSON(object.indentType) : 0,
            spread: isSet(object.spread) ? common_js_1.Quotation.fromJSON(object.spread) : undefined,
    ...
    toJSON(message) {
        const obj = {};
        if (message.indent !== undefined) {
            obj.indent = common_js_1.Quotation.toJSON(message.indent);
        }
        if (message.indentType !== 0) {
            obj.indentType = trailingValueTypeToJSON(message.indentType);
        }
        if (message.spread !== undefined) {
            obj.spread = common_js_1.Quotation.toJSON(message.spread);
        }
        if (message.spreadType !== 0) {
...
exports.StopOrder = {
    ...
    fromJSON(object) {
        return {
            ...
            stopPrice: isSet(object.stopPrice) ? common_js_1.MoneyValue.fromJSON(object.stopPrice) : undefined,
    ...
    toJSON(message) {
        ...
        if (message.stopPrice !== undefined) {
            obj.stopPrice = common_js_1.MoneyValue.toJSON(message.stopPrice);
        }
        if (message.instrumentUid !== "") {
...
exports.StopOrder_TrailingData = {
    encode(message, writer = minimal_js_1.default.Writer.create()) {
        ...
        if (message.price !== undefined) {
            common_js_1.Quotation.encode(message.price, writer.uint32(58).fork()).ldelim();
        }
        if (message.extr !== undefined) {
            common_js_1.Quotation.encode(message.extr, writer.uint32(66).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 8:
                    ...
                    message.extr = common_js_1.Quotation.decode(reader, reader.uint32());
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
                break;
    ...
    fromJSON(object) {
        return {
            ...
            price: isSet(object.price) ? common_js_1.Quotation.fromJSON(object.price) : undefined,
            extr: isSet(object.extr) ? common_js_1.Quotation.fromJSON(object.extr) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.extr !== undefined) {
            obj.extr = common_js_1.Quotation.toJSON(message.extr);
        }
        return obj;
    },
};
